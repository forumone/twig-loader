...
describe("include", function() {
  it("should generate correct code", function(done) {
    const template = path.join(fixtures, "include", "template.html.twig");
    runLoader(twigLoader, path.join(fixtures, "include"), template, fs.readFileSync(template, "utf-8"), (err, result) => {
      if(err) throw err;
